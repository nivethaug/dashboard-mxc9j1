...
import { LayoutDashboard, Settings, BarChart3, Menu, X, Sun, Activity, Wallet, Calendar as CalendarIcon, DollarSign } from "lucide-react";
...
const navItems = [
  ...
  { to: "/finance", label: "Finance", icon: DollarSign, testId: "navbar-link-finance" },
];
